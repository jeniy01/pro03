...
@WebServlet("/UpdateUser1.do")
public class UpdateUser1Ctrl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/user1/updateUser1.jsp");
