...
@WebServlet("/User1Detail.do")
public class User1DetailCtrl extends HttpServlet {
	...
	msg = "회원 정보를 로딩하였습니다.";
		...
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/admin/user1Detail.jsp");
