...
public class QnaDAO {
	...
	//해당 질문과 그 답변 그룹
	public ArrayList<QnaDTO> getQna(int qnum){
		ArrayList<QnaDTO> qnaList = new ArrayList<QnaDTO>();
		try {
			con = MySQL8.getConnection();
	...
	//질문 상세보기
	public QnaDTO getQna2(int qnum){
		QnaDTO qna = new QnaDTO();
		try {
			con = MySQL8.getConnection();
	...
	public ArrayList<QnaDTO> getReplyList(int qnum){
		ArrayList<QnaDTO> qnaList = new ArrayList<QnaDTO>();
		try {
			con = MySQL8.getConnection();
