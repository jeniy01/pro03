			...
			<table class="table">
				<tbody>
					...
					<tr>
						...
						<td>
							<textarea rows="10" cols="100" name="content" id="content" maxlength="990" title="1000자 내로 작성" class="textarea"></textarea>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<input type="submit" value="구매 후기 작성" class="button is-primary">
