...
<div class="container" style="padding-top:30px; margin-top:30px; border-top:3px solid #333; min-height:500px; ">
	<div class="field" style="text-align:center;">
		<h2 style="padding-top: 100px; padding-bottom:50px; font-size:30px;"><strong>글쓰기</strong></h2>
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<input type="text" name="ntitle" id="ntitle" maxlength="98" title="100자 내로 작성" placeholder="100자 내로 작성" class="form-control" required autofocus>
						</td>
					</tr>
					<tr>
						<th><label for="ncontent">글 내용</label></th>
						<td>
							<textarea rows="10" cols="100" name="ncontent" id="ncontent" maxlength="990" title="1000자 내로 작성" class="form-control"></textarea>
						</td>
					</tr>
					<tr>
