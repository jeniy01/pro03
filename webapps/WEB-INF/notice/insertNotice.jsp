				...
				<tbody>
					<tr>
						...
						<td>
							...
							<input type="text" name="ntitle" id="ntitle" maxlength="98" title="100자 내로 작성" placeholder="100자 내로 작성" class="input" required autofocus>
						</td>
					</tr>
					<tr>
						<th><label for="ncontent">글 내용</label></th>
						<td>
							<textarea rows="10" cols="100" name="ncontent" id="ncontent" maxlength="990" title="1000자 내로 작성" class="textarea"></textarea>
						</td>
					</tr>
					<tr>
