...
<div class="container is-fluid" style="padding-top:px;">
	<div class="field">
		<h2 style="text-align:center;">질문 글 쓰기</h2>
		<%-- <p>${msg }</p> --%>
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<input type="text" name="qtitle" id="qtitle" maxlength="98" title="100자 내로 작성" placeholder="100자 내로 작성" class="input" required autofocus>
						</td>
					</tr>
					<tr>
