		  ...
		  <div id="navbarBasicExample" class="navbar-menu">
		    <div class="navbar-item has-dropdown is-hoverable">
		        ...
		        <div class="navbar-dropdown">
		          <a href="${path1 }/" class="navbar-item">가평소개</a>
		          <a href="${path1 }/" class="navbar-item">가평여행소식</a>
		          <a href="${path1 }/" class="navbar-item">가평관광사진</a>
		        </div>
		      </div>
		      <div class="navbar-item has-dropdown is-hoverable">
		        <a class="navbar-link">관광명소</a>
		        <div class="navbar-dropdown">
		          <a href="${path1 }/" class="navbar-item">관광지</a>
		          <a href="${path1 }/" class="navbar-item">문화유적</a>
		        </div>
		      </div>
		      <div class="navbar-item has-dropdown is-hoverable">
		        <a class="navbar-link">숙박</a>
		        <div class="navbar-dropdown">
		          <a href="${path1 }/" class="navbar-item">관광호텔</a>
		          <a href="${path1 }/" class="navbar-item">일반숙박시설</a>
		          <a href="${path1 }/" class="navbar-item">야영장</a>
		        </div>
		      </div>
		      <div class="navbar-item has-dropdown is-hoverable">
		        <a class="navbar-link">맛집</a>
		        <div class="navbar-dropdown">
		          <a href="${path1 }/" class="navbar-item">100대 맛집</a>
		          <a href="${path1 }/" class="navbar-item">일반음식점</a>
		        </div>
		      </div>
		      <div class="navbar-item has-dropdown is-hoverable">
