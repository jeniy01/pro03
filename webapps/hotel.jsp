...
<div class="container is-fluid" style="padding-top:50px;">
	<div class="box">
	<h2 style="text-align:center; font-size:30px; padding-top:20px;"><strong>관광호텔</strong></h2>
	<img src="./img/hotel1.jpg" alt="" style="padding-top:50px; padding-left:px;">
	<img src="./img/hotel2.jpg" alt="" style="padding-left:px;">
	</div>
</div>
</div>
